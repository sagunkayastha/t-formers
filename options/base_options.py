...
class BaseOptions():
    ...
    def initialize(self, parser):
        # base define
        parser.add_argument('--name', type=str, default='network_TCEQ', help='name of the experiment.')
        ...
        parser.add_argument('--nThreads', type=int, default=12, help='# threads for loading data')
